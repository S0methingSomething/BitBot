...
class ExitMessages:
    ...
    CLIENT_INIT_FAILED_DESPITE_CREDS = "Client initialization failed despite credentials being present."

    # --- API & Connection Errors ---
    GITHUB_TOKEN_MISSING = "Missing GITHUB_TOKEN."  # nosec B105
    CREDENTIAL_VALIDATION_FAILED_API = "Credential validation failed at the API level."
    PREFLIGHT_CHECK_FAILED = "Credential validation failed. Please run 'test-credentials' for details."
